...
let patrons = {
  0: {
    ...
    lastName: 'McConnell',
    preferredName: '',
    emailAddress: 'patricia@rogue.com',
  ...
  4: {
    ...
    emailAddress: 'kikopup@rogue.com',
    password: 'recordDogs',
  ...
  5: {
    ...
    lastName: 'Ryan',
    preferredName: '',
    emailAddress: 'chickencamp@rogue.com',
    password: 'chickenz',
