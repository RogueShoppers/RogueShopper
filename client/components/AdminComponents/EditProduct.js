  ...
  return (
    ...
    <div>
      <form onSubmit={handleSubmit}>
        <label>Name:</label>
        <input name="name" onChange={handleChange} defaultValue={selectedProduct.name} />
        ...
        <label>Price:</label>
        <input name="price" onChange={handleChange} defaultValue={selectedProduct.price} />

        <label>Inventory Quantity:</label>
        <input name="quantity" onChange={handleChange} defaultValue={selectedProduct.quantity} />
